...
public final class ClassGenerator {
    ...
    public static ClassGenerator newInstance() {
        return new ClassGenerator(getClassPool(ClassGenerator.class.getClassLoader()));
    }
    ...
    public static ClassGenerator newInstance(ClassLoader loader, ProtectionDomain protectionDomain) {
        return new ClassGenerator(getClassPool(loader), protectionDomain);
    }
    ...
    private ClassGenerator(ClassPool pool, ProtectionDomain protectionDomain) {
        mPool = pool;
    ...
    public void release() {
        ...
        if (mProtectionDomain != null) {
            mProtectionDomain = null;
        }
    }
